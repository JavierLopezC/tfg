...
Todos estos ejemplos así como algunos extra están incluidos en la secciçon correspondiente a las variables de usuario y terapia adaptativa de la viñeta de OncoSimulR. Se puede encontrar en el link https://github.com/JavierLopezC/OncoSimul/blob/adaptive-ther/OncoSimulR/vignettes/OncoSimulR.Rmd a partir de la línea 12801. 
...
\chapter{Documentación de las principales funciones de R \label{sec:docum}}
...
\begin{itemize}
	\item modificación de la documentación de las funciones \textit{OncoSimulIndiv}, \textit{OncoSimulPop} y \textit{OncoSimulSample} para explicar los nuevos parámetros de la simulación. \\ https://github.com/JavierLopezC/OncoSimul/blob/adaptive-ther/OncoSimulR/man/oncoSimulIndiv.Rd.
	\item Elaboración de documentación extensa y con ejemplos de uso de las funciones \textit{createUserVariables} y \textit{createRules}, que son las accesibles directamente por el susario para la especificación de estos argumentos. \\ https://github.com/JavierLopezC/OncoSimul/blob/adaptive-ther/OncoSimulR/man/createUserVars.Rd.
\end{itemize}
